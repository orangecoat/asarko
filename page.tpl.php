 ...
 *
 * Asarko extras:
 * - $content_tag: The HTML tag to be used to surround the content (<article>
 *    if the page's content is a node, otherwise <section>)
 *
 * Regions:
...
?>
  ...
  <header id="page-header"><div id="page-header-inner">
  ...
  </div></header> <!-- /#page-header-inner, /#page-header -->
  ...
  <div id="page-main"><div id="page-main-inner">
  ...
  </div></div> <!-- /#page-main-inner, /#page-main -->

  <footer id="page-footer"><div id="page-footer-inner">
    <?php print render($page['footer']); ?>
  </div></footer> <!-- /#page-footer-inner, /#page-footer -->
